...
class CNN_Attention(tf.keras.Model):
    ...
    def call(self, inputs):
        ...
        #print("out.shape transoise: ",out.shape)
...
def test(model, test_inputs, test_labels):
    ...
    for i in range(int(test_inputs.shape[0]/model.batch_size)):
       ...
       # F1_score_macro = f1_score(flatten_y,flatten_logits,average='macro')
       # F1_score_micro = f1_score(flatten_y,flatten_logits,average='micro')
        #F1_score_weighted = f1_score(flatten_y,flatten_logits,average='weighted')
        #F1_macro = F1_macro.append(F1_score_macro)
        #F1_micro = F1_micro.append(F1_score_micro)
        #F1_weighted = F1_weighted.append(F1_score_weighted)
        #total_accuracy += accuracy
	
        #print("Test batch ", i, "AUROC score: ", score)
    #return total_accuracy / (int(test_inputs.shape[0]/model.batch_size))
   # print("F1_macro = ",tf.reduce_mean(F1_macro))
    #print("F1_micro = ",tf.reduce_mean(F1_micro))
    #print("F1_weighted = ",tf.reduce_mean(F1_weighted))
